...
class ReplicateSession {
    constructor(replicateKey = null){
        ...
        } else if (env.getEnv("REPLICATE_API_TOKEN")) {
            this.replicateKey = env.getEnv("REPLICATE_API_TOKEN");
        } else {
...
var ReplicateChatStrategy = /*#__PURE__*/ function(ReplicateChatStrategy) {
 ...
 */ class ReplicateLLM extends llms.BaseLLM {
    static{
...
If a question does not make any sense, or is not factually coherent, explain why instead of answering something not correct. If you don't know the answer to a question, please don't share false information.`;
        ...
        return {
            prompt: messages.reduce((acc, message, index)=>{
                const content = utils.extractText(message.content);
                if (index % 2 === 0) {
    ...
    async chat(params) {
        ...
        if (stream) {
            ...
            return utils.streamCallbacks(utils.streamConverter(stream, (chunk)=>{
                if (chunk.event === "done") {
                    return null;
                }
                return {
...
exports.ALL_AVAILABLE_REPLICATE_MODELS = ALL_AVAILABLE_REPLICATE_MODELS;
exports.DeuceChatStrategy = DeuceChatStrategy;
exports.LlamaDeuce = LlamaDeuce;
exports.ReplicateChatStrategy = ReplicateChatStrategy;
exports.ReplicateLLM = ReplicateLLM;
