...
var index_cjs$2 = require('../../csv/dist/index.cjs');
var index_cjs$4 = require('../../docx/dist/index.cjs');
var index_cjs$5 = require('../../html/dist/index.cjs');
var index_cjs$6 = require('../../image/dist/index.cjs');
var index_cjs$3 = require('../../markdown/dist/index.cjs');
var index_cjs$1 = require('../../pdf/dist/index.cjs');
...
const FILE_EXT_TO_READER = {
    ...
    pdf: new index_cjs$1.PDFReader(),
    csv: new index_cjs$2.CSVReader(),
    md: new index_cjs$3.MarkdownReader(),
    docx: new index_cjs$4.DocxReader(),
    htm: new index_cjs$5.HTMLReader(),
    html: new index_cjs$5.HTMLReader(),
    jpg: new index_cjs$6.ImageReader(),
    jpeg: new index_cjs$6.ImageReader(),
    png: new index_cjs$6.ImageReader(),
    gif: new index_cjs$6.ImageReader()
};
/**
