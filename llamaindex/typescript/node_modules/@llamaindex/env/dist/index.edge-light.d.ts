...
declare const AsyncLocalStorage: any;
...
export { AsyncLocalStorage, defaultCustomEvent as CustomEvent, EOL, type Logger, NotSupportCurrentRuntimeClass, Readable, type SHA256, consoleLogger, createSHA256, createWriteStream, emptyLogger, fileURLToPath, fs, getEnv, ok, process, randomUUID, setEnvs };
