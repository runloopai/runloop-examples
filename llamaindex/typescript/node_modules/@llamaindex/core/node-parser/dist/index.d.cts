import { z } from 'zod';
import { TransformComponent, BaseNode, TextNode, sentenceSplitterSchema, sentenceWindowNodeParserSchema, Document } from '../../schema/dist/index.cjs';
import { Tokenizer } from '@llamaindex/env/tokenizers';

declare abstract class NodeParser extends TransformComponent<BaseNode[]> {
