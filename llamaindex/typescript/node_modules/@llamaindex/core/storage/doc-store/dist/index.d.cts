import { StoredValue, BaseNode, ObjectType } from '../../../schema/dist/index.cjs';
...
export { BaseDocumentStore, type RefDocInfo, type Serializer, docToJson, isValidDocJson, jsonSerializer, jsonToDoc, noneSerializer };
