...
type ChatAppUpdate = {
    ...
    retrieval_config?: PresetRetrievalParams | null;
};
type ChatData = {
...
type ExtractMode = "PER_DOC" | "PER_PAGE";
...
type SupportedLLMModelNames = "GPT_3_5_TURBO" | "GPT_4" | "GPT_4_TURBO" | "GPT_4O" | "GPT_4O_MINI" | "AZURE_OPENAI" | "CLAUDE_3_5_SONNET";
...
type UpdateChatAppApiV1AppsIdPatchData = {
    body: ChatAppUpdate;
    path: {
        id: string;
    };
...
type UpdateChatAppApiV1AppsIdPatchResponse = ChatApp;
type UpdateChatAppApiV1AppsIdPatchError = HTTPValidationError;
...
type CreateExtractionAgentApiV1Extractionv2ExtractionAgentPostData = {
...
type CreateExtractionAgentApiV1Extractionv2ExtractionAgentPostResponse = ExtractAgent;
type CreateExtractionAgentApiV1Extractionv2ExtractionAgentPostError = HTTPValidationError;
...
type RunJobWithParsedFileApiV1Extractionv2JobsParsedPostResponse = ExtractResultset | null;
type RunJobWithParsedFileApiV1Extractionv2JobsParsedPostError = HTTPValidationError;
type RunJobsInBatchApiV1Extractionv2JobsBatchPostData = {
...
type RunJobsInBatchApiV1Extractionv2JobsBatchPostResponse = Array<ExtractJob>;
type RunJobsInBatchApiV1Extractionv2JobsBatchPostError = HTTPValidationError;
...
type RestartReportApiV1ReportsReportIdRetryPostData = {
    path: {
        report_id: string;
    };
    query?: {
...
type RestartReportApiV1ReportsReportIdRetryPostResponse = unknown;
type RestartReportApiV1ReportsReportIdRetryPostError = HTTPValidationError;
 ...
 * Update a chat app.
 */
declare const updateChatAppApiV1AppsIdPatch: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateChatAppApiV1AppsIdPatchData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ChatApp, HTTPValidationError, ThrowOnError>;
/**
 * Chat With Chat App
 ...
 */
declare const stripeWebhookApiV1BillingWebhookPost: <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<StripeWebhookApiV1BillingWebhookPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<unknown, HTTPValidationError, ThrowOnError>;
/**
 * Create Schema
 */
declare const createSchemaApiV1ExtractionSchemasPost: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateSchemaApiV1ExtractionSchemasPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionSchema, HTTPValidationError, ThrowOnError>;
/**
 * List Schemas
 */
declare const listSchemasApiV1ExtractionSchemasGet: <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListSchemasApiV1ExtractionSchemasGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ListSchemasApiV1ExtractionSchemasGetResponse, HTTPValidationError, ThrowOnError>;
/**
 * Infer Schema
 */
declare const inferSchemaApiV1ExtractionSchemasInferPost: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<InferSchemaApiV1ExtractionSchemasInferPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionSchema, HTTPValidationError, ThrowOnError>;
/**
 * Get Schema
 */
declare const getSchemaApiV1ExtractionSchemasSchemaIdGet: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetSchemaApiV1ExtractionSchemasSchemaIdGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionSchema, HTTPValidationError, ThrowOnError>;
/**
 * Update Schema
 */
declare const updateSchemaApiV1ExtractionSchemasSchemaIdPut: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateSchemaApiV1ExtractionSchemasSchemaIdPutData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionSchema, HTTPValidationError, ThrowOnError>;
/**
 * List Jobs
 */
 ...
 * Run Job
 */
declare const runJobApiV1ExtractionJobsPost: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RunJobApiV1ExtractionJobsPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionJob, HTTPValidationError, ThrowOnError>;
/**
 * Get Job
 */
declare const getJobApiV1ExtractionJobsJobIdGet: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetJobApiV1ExtractionJobsJobIdGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionJob, HTTPValidationError, ThrowOnError>;
/**
 * Run Jobs In Batch
 */
declare const runJobsInBatchApiV1ExtractionJobsBatchPost: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RunJobsInBatchApiV1ExtractionJobsBatchPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<RunJobsInBatchApiV1ExtractionJobsBatchPostResponse, HTTPValidationError, ThrowOnError>;
/**
 * Get Job Result
 */
declare const getJobResultApiV1ExtractionJobsJobIdResultGet: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetJobResultApiV1ExtractionJobsJobIdResultGetData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractionResult, HTTPValidationError, ThrowOnError>;
/**
 * Create Extraction Agent
 */
declare const createExtractionAgentApiV1Extractionv2ExtractionAgentPost: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateExtractionAgentApiV1Extractionv2ExtractionAgentPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<ExtractAgent, HTTPValidationError, ThrowOnError>;
/**
 ...
 */
declare const runJobWithParsedFileApiV1Extractionv2JobsParsedPost: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RunJobWithParsedFileApiV1Extractionv2JobsParsedPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<RunJobWithParsedFileApiV1Extractionv2JobsParsedPostResponse, HTTPValidationError, ThrowOnError>;
/**
 * Run Jobs In Batch
 */
declare const runJobsInBatchApiV1Extractionv2JobsBatchPost: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RunJobsInBatchApiV1Extractionv2JobsBatchPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<RunJobsInBatchApiV1Extractionv2JobsBatchPostResponse, HTTPValidationError, ThrowOnError>;
/**
 * Get Job Result
 */
 ...
 * Restart a report.
 */
declare const restartReportApiV1ReportsReportIdRetryPost: <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<RestartReportApiV1ReportsReportIdRetryPostData, ThrowOnError>) => _hey_api_client_fetch.RequestResult<unknown, HTTPValidationError, ThrowOnError>;
/**
 * Get Job Image Result
 * Get a job by id
 */
