 ...
 * Update Chat App
 * Update a chat app.
 */ const updateChatAppApiV1AppsIdPatch = (options)=>{
 ...
 */ const createExtractionAgentApiV1Extractionv2ExtractionAgentPost = (options)=>{
    return (options?.client ?? client).post({
        ...options,
        url: "/api/v1/extractionv2/extraction_agent"
    });
};
/**
 ...
 */ const listExtractionAgentsApiV1Extractionv2ExtractionAgentsGet = (options)=>{
    return (options?.client ?? client).get({
        ...options,
        url: "/api/v1/extractionv2/extraction_agents"
    });
};
/**
 ...
 */ const getExtractionAgentApiV1Extractionv2ExtractionAgentsExtractionAgentIdGet = (options)=>{
    return (options?.client ?? client).get({
        ...options,
        url: "/api/v1/extractionv2/extraction_agents/{extraction_agent_id}"
    });
};
/**
...
/**
 * Run Jobs In Batch
 */ const runJobsInBatchApiV1Extractionv2JobsBatchPost = (options)=>{
    return (options?.client ?? client).post({
        ...options,
        url: "/api/v1/extractionv2/jobs/batch"
    });
};
/**
 * Get Job Result
 ...
 * Restart Report
 * Restart a report.
 */ const restartReportApiV1ReportsReportIdRetryPost = (options)=>{
    return (options?.client ?? client).post({
        ...options,
        url: "/api/v1/reports/{report_id}/retry"
    });
};
/**
 * Get Job Image Result
