...
import { pipeline, PreTrainedTokenizer, PreTrainedModel } from '@huggingface/transformers';
...
declare class HuggingFaceEmbedding extends BaseEmbedding {
    ...
    getExtractor(): Promise<_huggingface_transformers.FeatureExtractionPipeline>;
...
export { type HFConfig, type HFLLMConfig, HuggingFaceEmbedding, HuggingFaceEmbeddingModelType, type HuggingFaceEmbeddingParams, HuggingFaceInferenceAPI, HuggingFaceInferenceAPIEmbedding, HuggingFaceLLM };
