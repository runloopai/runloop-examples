...
Object.defineProperty(exports, "PostgresKVStore", {
    enumerable: true,
    get: function() {
...
class PostgresKVStore extends _kvstore.BaseKVStore {
    schemaName;
    tableName;
    isDBConnected = false;
    ...
    async put(key, val, collection = _global.DEFAULT_COLLECTION) {
    ...
    async get(key, collection = _global.DEFAULT_COLLECTION) {
        const db = await this.getDb();
        try {
            await db.query("BEGIN");
    ...
    async getAll(collection = _global.DEFAULT_COLLECTION) {
        const db = await this.getDb();
        try {
            await db.query("BEGIN");
    ...
    async delete(key, collection = _global.DEFAULT_COLLECTION) {
        const db = await this.getDb();
        try {
            await db.query("BEGIN");
