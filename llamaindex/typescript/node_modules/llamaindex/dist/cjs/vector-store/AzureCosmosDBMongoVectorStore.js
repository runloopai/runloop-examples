...
_export(exports, {
    AzureCosmosDBMongoDBSimilarityType: function() {
        return AzureCosmosDBMongoDBSimilarityType;
    },
    AzureCosmosDBMongoDBVectorStore: function() {
        return AzureCosmosDBMongoDBVectorStore;
    }
});
...
const AzureCosmosDBMongoDBSimilarityType = {
    /** Cosine similarity */ COS: "COS",
    /** Inner - product */ IP: "IP",
    /** Euclidian distance */ L2: "L2"
};
class AzureCosmosDBMongoDBVectorStore extends _types.BaseVectorStore {
    storesText = true;
    flatMetadata = true;
    dbName;
    collectionName;
   ...
   */ mongodbClient;
    ...
    constructor(init){
        ...
        if (init.mongodbClient) {
            ...
            const mongoUri = (0, _env.getEnv)("AZURE_COSMOSDB_MONGODB_CONNECTION_STRING");
            if (!mongoUri) {
