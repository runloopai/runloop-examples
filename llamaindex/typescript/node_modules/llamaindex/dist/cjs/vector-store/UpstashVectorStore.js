...
Object.defineProperty(exports, "UpstashVectorStore", {
    enumerable: true,
    get: function() {
...
const _vector = require("@upstash/vector");
const _utils = require("./utils.js");
class UpstashVectorStore extends _types.BaseVectorStore {
    storesText = true;
    db;
    maxBatchSize;
    namespace;
   ...
   */ constructor(params){
        ...
        const token = params?.token ?? (0, _env.getEnv)("UPSTASH_VECTOR_REST_TOKEN");
        const endpoint = params?.endpoint ?? (0, _env.getEnv)("UPSTASH_VECTOR_REST_URL");
        if (!token) {
