...
export declare const AnthropicContextAwareAgent: {
    new (params: import("@llamaindex/anthropic").AnthropicAgentParams & import("./contextAwareMixin.js").ContextAwareConfig): {
