...
import type { Index, PineconeRecord, ScoredPineconeRecord } from "@pinecone-database/pinecone";
...
export declare class PineconeVectorStore extends BaseVectorStore {
    ...
    protected saveChunk(idx: Index, chunk: PineconeRecord[]): Promise<boolean>;
    /**
    ...
    metaWithoutText(meta: Metadata): Record<string, unknown>;
