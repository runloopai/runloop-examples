...
import * as LspAPI from "./lsp.js";
export declare class Lsp extends APIResource {
    /**
     * Apply a code action to a given code segment not all code actions are supported
     * yet
     */
    applyCodeAction(id: string, body: LspApplyCodeActionParams, options?: Core.RequestOptions): Core.APIPromise<CodeActionApplicationResult>;
    /**
     ...
     */
    codeActions(id: string, body: LspCodeActionsParams, options?: Core.RequestOptions): Core.APIPromise<unknown>;
    /**
     * Get diagnostics for a given file URI from the language server
     */
    diagnostics(id: string, body: LspDiagnosticsParams, options?: Core.RequestOptions): Core.APIPromise<DiagnosticsResponse>;
    /**
     * Get document symbols for a given document.
     */
    documentSymbols(id: string, body: LspDocumentSymbolsParams, options?: Core.RequestOptions): Core.APIPromise<unknown>;
    /**
     * Get the contents of a file at a given path relative to the root directory
     */
    file(id: string, body: LspFileParams, options?: Core.RequestOptions): Core.APIPromise<FileContentsResponse>;
    /**
     * Get the definition of a symbol at a given position in a file
     * https://microsoft.github.io/language-server-protocol/specifications/specification-current/#textDocument_definition
     */
    fileDefinition(id: string, body: LspFileDefinitionParams, options?: Core.RequestOptions): Core.APIPromise<unknown>;
    /**
     ...
     */
    getCodeActionsForDiagnostic(id: string, body: LspGetCodeActionsForDiagnosticParams, options?: Core.RequestOptions): Core.APIPromise<LspGetCodeActionsForDiagnosticResponse>;
    /**
     * Get the symbol, reference, and diagnostic information for a given code segment
     * in a file at a given depth
     */
    getCodeSegmentInfo(id: string, body: LspGetCodeSegmentInfoParams, options?: Core.RequestOptions): Core.APIPromise<CodeSegmentInfoResponse>;
    /**
     * Get the symbol, reference, and diagnostic information for a given code segment
     * in a file at a given depth
     */
    getSignatureHelp(id: string, body: LspGetSignatureHelpParams, options?: Core.RequestOptions): Core.APIPromise<SignatureHelpResponse>;
    /**
     ...
     * server
     */
    setWatchDirectory(id: string, body: LspSetWatchDirectoryParams, options?: Core.RequestOptions): Core.APIPromise<string>;
}
...
export declare namespace BaseRange {
    interface End {
        character: number;
        line: number;
    }
...
export declare namespace CodeSegmentInfoResponse {
    interface Hover {
        contents: unknown;
...
export declare namespace Lsp {
    export { type BaseCodeAction as BaseCodeAction, type BaseCommand as BaseCommand, type BaseDiagnostic as BaseDiagnostic, type BaseLocation as BaseLocation, type BaseMarkupContent as BaseMarkupContent, type BaseParameterInformation as BaseParameterInformation, type BaseRange as BaseRange, type BaseSignature as BaseSignature, type BaseWorkspaceEdit as BaseWorkspaceEdit, type CodeActionApplicationResult as CodeActionApplicationResult, type CodeActionContext as CodeActionContext, type CodeActionKind as CodeActionKind, type CodeActionsForDiagnosticRequestBody as CodeActionsForDiagnosticRequestBody, type CodeActionsRequestBody as CodeActionsRequestBody, type CodeActionsResponse as CodeActionsResponse, type CodeActionTriggerKind as CodeActionTriggerKind, type CodeDescription as CodeDescription, type CodeSegmentInfoRequestBody as CodeSegmentInfoRequestBody, type CodeSegmentInfoResponse as CodeSegmentInfoResponse, type Diagnostic as Diagnostic, type DiagnosticRelatedInformation as DiagnosticRelatedInformation, type DiagnosticSeverity as DiagnosticSeverity, type DiagnosticsResponse as DiagnosticsResponse, type DiagnosticTag as DiagnosticTag, type DocumentSymbol as DocumentSymbol, type DocumentSymbolResponse as DocumentSymbolResponse, type DocumentUri as DocumentUri, type FileContentsResponse as FileContentsResponse, type FileDefinitionRequestBody as FileDefinitionRequestBody, type FileDefinitionResponse as FileDefinitionResponse, type FilePath as FilePath, type FileRequestBody as FileRequestBody, type FileUri as FileUri, type FormattingResponse as FormattingResponse, type HealthStatusResponse as HealthStatusResponse, type Integer as Integer, type Location as Location, type LSpAny as LSpAny, type Position as Position, type Range as Range, type RecordStringTextEditArray as RecordStringTextEditArray, type ReferencesRequestBody as ReferencesRequestBody, type ReferencesResponse as ReferencesResponse, type SetWatchDirectoryRequestBody as SetWatchDirectoryRequestBody, type SignatureHelpRequestBody as SignatureHelpRequestBody, type SignatureHelpResponse as SignatureHelpResponse, type SymbolKind as SymbolKind, type SymbolTag as SymbolTag, type SymbolType as SymbolType, type TextEdit as TextEdit, type Uinteger as Uinteger, type URi as URi, type WatchedFileResponse as WatchedFileResponse, type LspFilesResponse as LspFilesResponse, type LspGetCodeActionsForDiagnosticResponse as LspGetCodeActionsForDiagnosticResponse, type LspSetWatchDirectoryResponse as LspSetWatchDirectoryResponse, type LspApplyCodeActionParams as LspApplyCodeActionParams, type LspCodeActionsParams as LspCodeActionsParams, type LspDiagnosticsParams as LspDiagnosticsParams, type LspDocumentSymbolsParams as LspDocumentSymbolsParams, type LspFileParams as LspFileParams, type LspFileDefinitionParams as LspFileDefinitionParams, type LspFormattingParams as LspFormattingParams, type LspGetCodeActionsForDiagnosticParams as LspGetCodeActionsForDiagnosticParams, type LspGetCodeSegmentInfoParams as LspGetCodeSegmentInfoParams, type LspGetSignatureHelpParams as LspGetSignatureHelpParams, type LspReferencesParams as LspReferencesParams, type LspSetWatchDirectoryParams as LspSetWatchDirectoryParams, };
}
