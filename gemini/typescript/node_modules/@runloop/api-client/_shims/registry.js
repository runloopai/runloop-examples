...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import '@runloop/api-client/shims/${shims.kind}'\` before importing anything else from @runloop/api-client`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import '@runloop/api-client/shims/${shims.kind}'\` after \`import '@runloop/api-client/shims/${exports.kind}'\``);
    }
