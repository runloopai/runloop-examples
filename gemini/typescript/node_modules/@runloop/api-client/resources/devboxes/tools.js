...
exports.DevboxTools = void 0;
const tools_1 = require("../../lib/tools.js");
        ...
        const tools = [
            (0, tools_1.createTool)({
                ...
                parameters: zod_1.z.object({
                    file_path: zod_1.z.string().describe('The path of the file to read relative to the user home directory'),
                }),
            ...
            (0, tools_1.createTool)({
                ...
                parameters: zod_1.z.object({
                    file_path: zod_1.z.string().describe('The path of the file to write relative to the user home directory'),
                    contents: zod_1.z.string().describe('The contents to write to the file'),
                }),
                execute: async (params) => {
                    try {
    ...
    shellTools(devboxId, options) {
        const tools = [
            ...
            (0, tools_1.createTool)({
                ...
                parameters: zod_1.z.object({
                    command: zod_1.z.string().describe('The shell command to execute asynchronously'),
                }),
                execute: async (params) => {
                    try {
            ...
            (0, tools_1.createTool)({
                ...
                parameters: zod_1.z.object({
                    execution_id: zod_1.z.string().describe('The ID of the async execution to retrieve'),
                }),
                execute: async (params) => {
                    try {
    ...
    tunnelTools(devboxId, options) {
        const tools = [
            (0, tools_1.createTool)({
                ...
                parameters: zod_1.z.object({
                    port: zod_1.z.number().describe('The port number to tunnel'),
                    protocol: zod_1.z.enum(['http', 'https', 'tcp']).describe('The protocol to use for the tunnel'),
                }),
                execute: async (params) => {
                    try {
...
exports.DevboxTools = DevboxTools;
