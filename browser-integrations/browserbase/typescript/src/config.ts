 ...
 *
 * Holds the blueprint definition, the default crawl targets, the in-devbox
...
/** Name of the blueprint that bakes the Browserbase SDK + Playwright client into a devbox image. */
export const BLUEPRINT_NAME = "browserbase-browser";
 ...
 * runs on Browserbase, and `connect_over_cdp` drives it remotely. `--user`
 * avoids PEP 668 ("externally-managed-environment") failures on the base image.
 */
export const SYSTEM_SETUP_COMMANDS: string[] = ["python3 -m pip install --user browserbase playwright"];
...
export const DEFAULT_LINKS_PER_SEED = 10;
...
/**
 * Source of the in-devbox crawl agent (`agent.py`), embedded verbatim.
 *
 ...
 */
export const AGENT_SCRIPT = `"""In-devbox research agent.
